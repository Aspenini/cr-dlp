module CrDlp
  module ISO639
    SHORT_TO_LONG = {
      ...
      "he" => "heb", "iw" => "heb", "hi" => "hin", "ho" => "hmo",
      "hr" => "hrv", "ht" => "hat", "hu" => "hun", "hy" => "hye",
      "hz" => "her", "ia" => "ina", "id" => "ind", "in" => "ind",
      "ie" => "ile", "ig" => "ibo", "ii" => "iii", "ik" => "ipk",
      "io" => "ido", "is" => "isl", "it" => "ita", "iu" => "iku",
      "ja" => "jpn", "jv" => "jav", "ka" => "kat", "kg" => "kon",
      "ki" => "kik", "kj" => "kua", "kk" => "kaz", "kl" => "kal",
      "km" => "khm", "kn" => "kan", "ko" => "kor", "kr" => "kau",
      "ks" => "kas", "ku" => "kur", "kv" => "kom", "kw" => "cor",
      "ky" => "kir", "la" => "lat", "lb" => "ltz", "lg" => "lug",
      "li" => "lim", "ln" => "lin", "lo" => "lao", "lt" => "lit",
      "lu" => "lub", "lv" => "lav", "mg" => "mlg", "mh" => "mah",
      "mi" => "mri", "mk" => "mkd", "ml" => "mal", "mn" => "mon",
      "mr" => "mar", "ms" => "msa", "mt" => "mlt", "my" => "mya",
      "na" => "nau", "nb" => "nob", "nd" => "nde", "ne" => "nep",
      "ng" => "ndo", "nl" => "nld", "nn" => "nno", "no" => "nor",
      "nr" => "nbl", "nv" => "nav", "ny" => "nya", "oc" => "oci",
      "oj" => "oji", "om" => "orm", "or" => "ori", "os" => "oss",
      "pa" => "pan", "pe" => "per", "pi" => "pli", "pl" => "pol",
      ...
      "wo" => "wol", "xh" => "xho", "yi" => "yid", "ji" => "yid",
      "yo" => "yor", "za" => "zha", "zh" => "zho", "zu" => "zul",
    }

    def self.short_to_long(code : String) : String?
      SHORT_TO_LONG[code[0, Math.min(2, code.size)].downcase]?
    end
  end
end
